  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      AppBar(
        ...
        title: const Center(child: Text("Edit Posts",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white))),
        actions: [
          InkWell(
            onTap: () async {
                Todo todo = Todo(
      ...
      AppBar(
        ...
        title: const Center(child: Text("New Posts",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white))),
        actions: [
          InkWell(
            onTap: () async {
              Todo todo = Todo(
